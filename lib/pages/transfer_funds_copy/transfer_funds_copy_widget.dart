...
import 'transfer_funds_copy_model.dart';
export 'transfer_funds_copy_model.dart';

class TransferFundsCopyWidget extends StatefulWidget {
  const TransferFundsCopyWidget({super.key});

  static String routeName = 'transferFundsCopy';
  static String routePath = '/transferFundsCopy';

  @override
  State<TransferFundsCopyWidget> createState() =>
      _TransferFundsCopyWidgetState();
}

class _TransferFundsCopyWidgetState extends State<TransferFundsCopyWidget> {
  late TransferFundsCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TransferFundsCopyModel());
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          Text(
            FFLocalizations.of(context).getText(
              '2spd5t72' /* Tap above to complete transfer */,
            ),
